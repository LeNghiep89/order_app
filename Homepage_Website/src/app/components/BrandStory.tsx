      ...
      >
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            >
              Từ căn bếp của mẹ Lân đến những bữa gặp gỡ đáng nhớ
            </h2>
            ...
            >
              Với Madame Lân, một bữa ăn ngon không chỉ nằm ở món ăn đúng vị. Đó còn là cảm giác mọi người cùng ngồi lại, cùng kể chuyện và tận hưởng thời gian bên nhau.

Lấy cảm hứng từ những món ăn Việt quen thuộc, đặc biệt là hương vị miền Trung, chúng tôi chọn cách giữ gìn sự gần gũi ấy bằng nguyên liệu tươi ngon, cách chế biến chỉn chu và sự hiếu khách chân thành.

Bởi đôi khi, những khoảnh khắc đáng nhớ nhất lại bắt đầu từ một bữa ăn ngon.
            </p>
