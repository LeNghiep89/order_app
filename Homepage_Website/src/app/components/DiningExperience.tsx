    ...
    <section className="pt-40 pb-32" style={{ backgroundColor: "var(--ivory)" }}>
      ...
      >
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
            Một góc phù hợp cho từng cuộc gặp gỡ
          </h2>
          ...
          >
            Dù là bữa ăn thân mật hay dịp sum họp đông người, Madame Lân luôn có những không gian được chuẩn bị để bạn thấy thoải mái và trọn vẹn nhất.
          </p>
        </div>
