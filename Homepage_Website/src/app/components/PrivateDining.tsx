      ...
      >
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            >
              Giữ chỗ cho một buổi gặp gỡ đáng nhớ
            </h2>
            ...
            >
              Dù là bữa cơm gia đình cuối tuần, tiếp khách hay một dịp đặc biệt, đội ngũ Madame Lân luôn sẵn sàng chuẩn bị không gian phù hợp nhất để bạn chỉ cần đến và tận hưởng.
            </p>
