    ...
    <section className="py-32" style={{ backgroundColor: "var(--ivory)" }}>
      ...
      >
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
            Những trải nghiệm được nhớ sau mỗi bữa ăn
          </h2>
          ...
          >
            Điều chúng tôi trân quý nhất là cảm giác khách muốn quay lại — để gặp gỡ, thưởng thức và tiếp tục những câu chuyện còn dang dở.
          </p>
        </div>
